...
- 한 줄 요약: 고윤정 위키의 사용법/규칙/자동화 운영을 한 페이지에서 안내합니다.
- 핵심 링크: [허브](pages/hub.md) · [인덱스](index.md) · 오늘 로그(news/YYYY-MM-DD.md) · [일일 리포트](pages/daily-report.md)
- 상태: 운영 문서(S/A 링크 기반) · 자동화 동작 기준점
...
- [목차](#목차)
- [✅ 바로 시작하기 (Start here)](#바로-시작하기-start-here)
- [🧭 추천 탐색 루트](#추천-탐색-루트)
- [🗂️ 무엇이 정리되어 있나요?](#무엇이-정리되어-있나요)
  - [핵심 정리(정리본)](#핵심-정리정리본)
  - [아카이브(링크 모음)](#아카이브링크-모음)
- [🧪 신뢰도(근거 수준) 표기](#신뢰도근거-수준-표기)
- [🧪 품질/상태 리포트(운영자용)](#품질상태-리포트운영자용)
- [🗓️ 자동 업데이트/백업/요약(스케줄)](#자동-업데이트백업요약스케줄)
  - [실행 상태 확인(중요)](#실행-상태-확인중요)
  - [1일 1커밋 원칙](#1일-1커밋-원칙)
- [📌 편집 원칙(중요)](#편집-원칙중요)
- [📁 폴더 구조(요약)](#폴더-구조요약)
- [🔎 수집(Watch) 출발점](#수집watch-출발점)
- [📱 휴대폰에서 보기(추천)](#휴대폰에서-보기추천)
- [🧰 개발/점검(로컬)](#개발점검로컬)
- [🙋 FAQ](#faq)
  - [Q. “관련 링크(자동 후보)”는 뭔가요?](#q-관련-링크자동-후보는-뭔가요)
  - [Q. 왜 내용이 ‘링크’ 중심인가요?](#q-왜-내용이-링크-중심인가요)
- [❤️](#)
...
- 오늘 로그 → [`news/2026-02-18.md`](news/2026-02-18.md)
...
- **최근 7일 요약**: [`news/README.md`](news/README.md)
- **오늘 로그(자동 실행/결과)**: `news/YYYY-MM-DD.md` (예: [`news/2026-02-18.md`](news/2026-02-18.md))
