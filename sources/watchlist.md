...
- (추정) 공식 팬카페(다음 카페): https://cafe.daum.net/goyounjung.fans
  - 무인 수집: 로그인/권한/동적 로딩 이슈가 있을 수 있어 '변경 신호(접속/리다이렉트/헤더)'만 감지
...
## 주요 언론/매거진(대량 수집용)
- 상세 목록 및 사이트별 검색 링크 모음: `sources/media-watch.md`
- 브랜드/캠페인(공식 채널 고정 확인): `sources/brands-watch.md`

(매일 9시 업데이트 시에는 위 파일을 참고해 ‘많이 수집 → 잘 분류’ 흐름으로 정리합니다.)
