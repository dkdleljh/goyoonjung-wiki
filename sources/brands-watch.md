# 브랜드 Watch (광고/캠페인 커버리지 올리기)

> 목적: 고윤정 관련 **광고/캠페인/엠버서더**를 누락 없이 모으기 위해 브랜드 공식 채널을 고정으로 확인합니다.
> 원칙: 최종 기록은 `pages/endorsements/*`에 **공식 링크(1차)** 로만 확정합니다.

## 사용 방법(매일/주간)
- 새 캠페인/티저/메이킹/화보가 뜨면:
  1) `sources/seen-urls.txt` 중복 확인
  2) `id:`에 URL 기록 + `seen-urls.txt`에 추가
  3) 카테고리(뷰티/패션/라이프스타일)로 착지
...
- YUNJAC(연작): https://www.yunjac.com/
- Espoir(에스쁘아): https://www.espoir.com/
...
- DIDIER DUBOT: https://www.didierdubot.co.kr/ (확인 필요)
