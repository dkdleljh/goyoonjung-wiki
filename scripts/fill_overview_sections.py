...
DATA: dict[str, dict[str, str]] = {
    ...
    "docs/README.md": {
        ...
        "links": "[편집 정책](editorial_policy.md) · [점수](scoring.md) · [로드맵](ROADMAP_EXECUTION.md)",
        "status": "운영 문서",
    },
    "CHANGELOG.md": {
