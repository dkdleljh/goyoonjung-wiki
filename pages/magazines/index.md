...
> 목적: 화보/인터뷰/커버 관련 링크를 매거진별로 모아, 빠르게 선별·정리할 수 있도록 합니다.
> 원칙: 후보는 자동 생성(키워드 매칭)이며, 최종 확정은 `pages/pictorials/*` 및 `pages/interviews.md`에 기록합니다.

- [Marie Claire Korea](marieclaire.md)
- [Vogue Korea](vogue.md)
- [ELLE Korea](elle.md)
- [Harper's BAZAAR Korea](bazaar.md)
- [W Korea](wkorea.md)
- [GQ Korea](gq.md)
