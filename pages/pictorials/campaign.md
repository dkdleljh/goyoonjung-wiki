...
## 2025
- 날짜: 2025-05-26
- 매체/브랜드: 상쾌환(EASY TOMORROW) / Vogue Korea
- 구분: 프로모션/캠페인(화보)
- 제목: Go ZERO, Now ZERO
...
## 2024
- 날짜: 2024-05-03
- 매체/브랜드: CHANEL / Vogue Korea
- 구분: 행사/룩(기사)
- 제목: 샤넬 크루즈 2024/25 쇼에 참석한 고윤정
...
- 구분: 캠페인/화보(브랜드 원문)
- 제목: 라타플랑(공식 사이트 게시글)
- 링크(원문): https://rataplan.co.kr/article/%EB%A7%A4%EA%B1%B0%EC%A7%84/8/1157
- 상태: 공식확정
...
- 날짜: 미상(공식 게시물의 업로드/게시일 자동 추출 실패)
- 매체/브랜드: 보다나(VODANA)
- 구분: 광고(영상)
- 제목: 보다나 공식 광고 영상
...
## 출처
- (S/A) 각 항목의 원문 URL(브랜드/매거진 공식 페이지, 공식 캠페인 영상)
