...
- 한 줄 요약: 공식 공개 일정(공개/방영/행사)을 확정 근거로만 기록하는 캘린더입니다.
- 핵심 링크: 오늘/이번주(자동) · 지난 일정(연도별) · [출연/행사](appearances.md)
- 상태: 확정 일정만(공식/검증 링크 필수) · 지나면 Past로 이동

<!-- AUTO-SCHEDULE-HIGHLIGHTS:START -->
## 오늘/이번주 일정 (자동)
> 기준: 2026-02-27 ~ 2026-03-06 (Asia/Seoul)
